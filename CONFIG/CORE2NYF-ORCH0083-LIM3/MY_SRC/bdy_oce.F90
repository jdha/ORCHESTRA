MODULE bdy_oce
   ...
   TYPE, PUBLIC ::   OBC_DATA     !: Storage for external data
      ...
      !
      !DRM - add a real that can be set to a constant value and pointed at by trc.
      REAL(wp)                            :: const = 0.0   !: a number for trc to point at.
      !
...
!$AGRIF_END_DO_NOT_TREAT
   ...
   !! $Id: bdy_oce.F90 7753 2017-03-03 11:46:59Z mocavero $ 
