MODULE diahth
   ...
   !! $Id: diahth.F90 6140 2015-12-21 11:35:23Z timgraham $ 
...
CONTAINS
   ...
   SUBROUTINE dia_hth( kt )
      ...
      DO jj = 1, jpj
         DO ji = 1, jpi
            ! DRM, 23/11/17 - bathy variable doesn't have an implicit type because somebody killed it and there's no testing.
            !zztmp = bathy(ji,jj)
