...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: diawri.F90 10114 2018-09-12 08:31:10Z andmirek $
...
CONTAINS
   ...
   SUBROUTINE dia_wri( kt )
      ...
      !
      CALL iom_put( "gdept_n" , gdept_n(:,:,:) )
      CALL iom_put( "gdepw_n" , gdepw_n(:,:,:) )
      CALL iom_put( "gdept_0" , gdept_0(:,:,:) )
      CALL iom_put( "gdepw_0" , gdepw_0(:,:,:) )
