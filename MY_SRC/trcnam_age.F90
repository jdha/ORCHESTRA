...
CONTAINS
   ...
   SUBROUTINE trc_nam_age
      ...
      !
      ! DRM - settings for Northern boundary age tracer.
      ctrcnm    (jp_age+1) = 'NAge'
      ctrcln    (jp_age+1) = 'Sea water age since northern boundary contact'
      ctrcun    (jp_age+1) = 'year'
      ln_trc_ini(jp_age+1) = .false.
      ln_trc_sbc(jp_age+1) = .false.
      ln_trc_cbc(jp_age+1) = .false.
      ln_trc_obc(jp_age+1) = .false.
      !
