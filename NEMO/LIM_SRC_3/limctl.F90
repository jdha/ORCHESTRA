MODULE limctl
   ...
   !!            3.7  !  2016-10  (C. Rousset)       Add routine lim_prt3D
   !!----------------------------------------------------------------------
#if defined key_lim3
   !!----------------------------------------------------------------------
   ...
   !!    lim_prt3D : control prints of ice arrays
   !!----------------------------------------------------------------------
...
!     ! Alert if too old ice
   ...
   SUBROUTINE lim_prt3D( cd_routine )
      !!---------------------------------------------------------------------------------------------------------
      !!                                   ***  ROUTINE lim_prt3D ***
      !!
      ...
      DO jl = 1, jpl
         ...
         CALL prt_ctl_info('   ~~~~~~~~~~')
         CALL prt_ctl(tab2d_1=ht_i       (:,:,jl)        , clinfo1= ' ht_i        : ')
         CALL prt_ctl(tab2d_1=ht_s       (:,:,jl)        , clinfo1= ' ht_s        : ')
      ...
      CALL prt_ctl(tab2d_1=u_oce      , clinfo1= ' u_oce     : ', tab2d_2=v_oce      , clinfo2= ' v_oce     : ')
      
   END SUBROUTINE lim_prt3D
...
CONTAINS
   ...
   END SUBROUTINE lim_prt
   SUBROUTINE lim_prt3D   ! Empty routine
   END SUBROUTINE lim_prt3D
#endif
   !!======================================================================
END MODULE limctl
