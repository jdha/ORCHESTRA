MODULE domc1d
   ...
   USE dom_oce , ONLY : nimpp, njmpp ! Shared/distributed memory setting
   !
   ...
   !! $Id: domc1d.F90 7646 2017-02-06 09:25:03Z timgraham $ 
...
CONTAINS
   ...
   SUBROUTINE dom_c1d( plat, plon )
      ...
      !!----------------------------------------------------------------------
      REAL(wp), INTENT(in) ::  plat, plon    ! Column latitude &  longitude
      !
