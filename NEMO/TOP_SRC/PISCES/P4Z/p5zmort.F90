...
CONTAINS
   ...
   SUBROUTINE p5z_nano
      ...
      !!---------------------------------------------------------------------
      !
      IF( nn_timing == 1 )  CALL timing_start('p5z_nano')
      !
      ...
      !
       ...
       ENDIF
      !
      IF( nn_timing == 1 )  CALL timing_stop('p5z_nano')
      !
   ...
   SUBROUTINE p5z_pico
      ...
      !!---------------------------------------------------------------------
      !
      IF( nn_timing == 1 )  CALL timing_start('p5z_pico')
      !
      DO jk = 1, jpkm1
         DO jj = 1, jpj
            DO ji = 1, jpi
      ...
      !
       ...
       ENDIF
      !
      IF( nn_timing == 1 )  CALL timing_stop('p5z_pico')
      !
   ...
   SUBROUTINE p5z_diat
      ...
      !!---------------------------------------------------------------------
      !
      IF( nn_timing == 1 )  CALL timing_start('p5z_diat')
      !
      ...
      ENDIF
      !
      IF( nn_timing == 1 )  CALL timing_stop('p5z_diat')
      !
